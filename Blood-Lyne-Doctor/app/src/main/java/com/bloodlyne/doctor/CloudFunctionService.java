...
public class CloudFunctionService extends AsyncTask<String, Void, String> {

    private URL url;
    private String jsonString;
    private AsyncResponse asyncResponse;

    public CloudFunctionService(URL url, String jsonString, AsyncResponse asyncResponse) {
        this.url = url;
